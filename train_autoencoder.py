...
def main(args):
    ...
    tokenizer_filename = f"bgp-{args.tokenizer_type}-tokenizer.json"
    ...
    # --- Data Loading ---
    train_dataset = ASPathDataset(tokenizer, "train.txt", max_length=args.max_length)
    val_dataset = ASPathDataset(tokenizer, "validation.txt", max_length=args.max_length)
